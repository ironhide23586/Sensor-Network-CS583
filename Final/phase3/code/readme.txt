...
This folder contains the main python file named "Phase3_00.py". The folder skeleton structure necessary for program execution has already been laid out (empty folder titled "results"(containing 2 empty folders) and folder containing data files titled "intelLabDataProcessed") which should not be modified.
...
-sklearn.linear_model: used to import the Lasso class for regression.
